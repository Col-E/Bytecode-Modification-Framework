...
public class ClassWriter {
    ...
    private static void writeAttribute(DataOutputStream ds, Attribute attribute) throws IOException {
        ...
        case CODE:
            ...
            writeMethodCode(code.instructions, ds);
    ...
    private static void writeMethodCode(MethodCode code, DataOutputStream ds) throws IOException {
        // TODO: Actually write instructions (Pre-req: reading them correctly)
        ds.writeInt(code.original.length);
        ds.write(code.original);
    }
    ...
    private static void writeConstant(DataOutputStream ds, Constant constant) throws IOException {
        switch(constant.type) {
            ...
            case CLASS:
                ...
                break;
            case MODULE:
                ConstModule constModule = (ConstModule) constant;
                ds.writeShort(constModule.getValue());
                break;
            case PACKAGE:
                ConstPackage constPackage = (ConstPackage) constant;
                ds.writeShort(constPackage.getValue());
                break;
            case FIELD:
            ...
            case INVOKEDYNAMIC:
                ...
                break;
            case DYNAMIC:
                ConstDynamic constDynamic = (ConstDynamic) constant;
                ds.writeShort(constDynamic.getBootstrapAttribute());
                ds.writeShort(constDynamic.getNameTypeIndex());
                break;
            case METHOD_HANDLE:
